...
| `sauce-soja-sucre.png` | slim dark glass sweet soy sauce bottle with red cap, keeping its real narrow bottle shape, with a kawaii face on the bottle body — sweet half-closed eyes, gentle smile, rosy cheeks — deep dark brown with warm amber tint, side view |
| `sauce-sriracha.png` | tall slim red plastic sriracha squeeze bottle with green cap, keeping its real iconic tall bottle shape, with a kawaii face on the bottle body — fiery determined eyes, cheeky grin, rosy cheeks — vivid bright red, side view |
...
| `nems.png` | two golden crispy fried spring rolls (nems) side by side, keeping their real cylindrical shape, the front one with a kawaii face on the wrapper — big glossy eyes, happy smile, rosy cheeks — warm golden-brown, 3/4 view |
...
| `levure.png` | small sachet of baking yeast powder, keeping its real pillow packet shape, with a kawaii face on the front — big eyes, happy smile, rosy cheeks — soft cream with golden stripe, front view |
| `muscade.png` | small round whole nutmeg seed, keeping its real oval shape, with a kawaii face on the surface — big eyes, cozy smile, rosy cheeks — warm brown marbled tones, side view |
...
| `amandes.png` | handful of whole almonds, keeping their real teardrop shapes, the largest one with a kawaii face — big glossy eyes, smile, rosy cheeks — warm toasted brown skin, top view |
...
| `tisane.png` | rectangular herbal tea box with a tea bag dangling over the edge, keeping its real box shape, with a kawaii face on the box front — dreamy relaxed eyes, peaceful smile, rosy cheeks — soft lavender and green tones with chamomile flower, 3/4 view |
...
| `apres-shampooing.png` | conditioner bottle with smooth rounded body and flip top cap, slightly wider at the base than the shampoo bottle, keeping its real bottle shape, with a kawaii face on the bottle body — big dreamy eyes, silky smooth smile, rosy cheeks — soft lavender and white, side view |
